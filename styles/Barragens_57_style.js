...
var style_Barragens_57 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        ...
        image: new ol.style.RegularShape({radius: 6.0 + size, points: 6,
            stroke: new ol.style.Stroke({color: 'rgba(255,255,255,0.996078431372549)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(166,206,227,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
